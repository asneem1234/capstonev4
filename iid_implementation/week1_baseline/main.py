# Main training loop - simple baseline
import torch
...
def main():
    print("=" * 70)
    print("Federated Learning - Simple Baseline")
    print("=" * 70)
    ...
    for round_num in range(Config.NUM_ROUNDS):
        ...
        for i, client in enumerate(clients):
            ...
            print(f"  Client {i}: Train Acc={train_acc:.2f}%, Loss={train_loss:.4f}, Update Norm={update_norm:.4f}")
