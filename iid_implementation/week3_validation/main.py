# Main training loop - with attack and defense
import torch
...
def main():
    print("=" * 70)
    print("Federated Learning - WITH ATTACK AND VALIDATION DEFENSE")
    print("=" * 70)
    ...
    for round_num in range(Config.NUM_ROUNDS):
        ...
        print("\n[SERVER AGGREGATION]")
        agg_norm, validation_results = server.aggregate(client_updates)
        ...
        if Config.DEFENSE_ENABLED and validation_results:
            ...
            for result in validation_results:
                ...
                print(f"    Client {result['client_id']}: {status} "
