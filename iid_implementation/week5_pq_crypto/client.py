# Client training with optional attack and PQ crypto
import torch
...
class Client:
    ...
    def train(self, global_model, server_public_key=None, round_num=0):
        """Train on local data, return update with optional crypto"""
        # Copy global model
        ...
        if Config.USE_PQ_CRYPTO and self.pq_crypto and server_public_key:
            # Sign the update
            message = hash_update(update, None, self.client_id, round_num)
