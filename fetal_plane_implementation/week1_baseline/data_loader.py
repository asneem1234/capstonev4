...
class FetalPlaneDataset(Dataset):
    """
    Custom dataset for fetal plane images from CSV metadata.
    
    Reads from FETAL_PLANES_DB_data.csv and loads images from Images/ folder.
...
def load_fetal_plane_data():
    """Load fetal plane dataset from CSV"""
...
def get_client_loaders(num_clients, alpha=0.5):
    ...
    if len(train_dataset) == 0:
        ...
        print("  cd ../../../non_iid_implementation/week1_baseline")
