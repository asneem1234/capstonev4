"""
Quick Test Configuration for Quantum Federated Learning
Use this for fast testing, then switch back to config.py for full runs
"""

# ===== Federated Learning Settings =====
NUM_CLIENTS = 3  # Minimal for testing
CLIENTS_PER_ROUND = 3  # All clients participate
NUM_ROUNDS = 1  # Just one round for quick test
...
BATCH_SIZE = 128  # Larger batches = fewer iterations
LOCAL_EPOCHS = 1  # Minimal training
LEARNING_RATE = 0.01
...
def print_config():
    ...
    print("\n" + "="*60)
    print("Quantum Federated Learning Configuration (QUICK TEST)")
    print("="*60)
