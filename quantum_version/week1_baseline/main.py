"""
Main entry point for Quantum Federated Learning (Baseline - No Attack)
...
def client_fn(context: Context):
    ...
    # Debug: show extracted id and context repr (helps when flwr Context shapes differ)
    try:
...
def main():
    ...
    print("="*60)
    print("Quantum Federated Learning - Week 1 Baseline (No Attack)")
    print("="*60)
